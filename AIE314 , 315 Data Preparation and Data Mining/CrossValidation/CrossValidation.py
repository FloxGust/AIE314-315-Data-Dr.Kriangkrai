...
def f(x):
    return  0.5*x**3 - 0.7*x**2 - 0.2*x + 3.14
...
print(" Validation set _________________________________________________________________________________________________________________________")
...
print(" k-fold Cross-Validation _________________________________________________________________________________________________________________________")

from sklearn.model_selection import KFold

kcv = KFold(n_splits=10, random_state=14, shuffle=True)
...
print(" Leave-One-Out Cross-Validation _________________________________________________________________________________________________________________________")
...
print(" Leave-P-Out (LPOCV) _________________________________________________________________________________________________________________________")
...
print(" Shuffle Splits _________________________________________________________________________________________________________________________")

from sklearn.model_selection import ShuffleSplit
ss = ShuffleSplit(n_splits=10, test_size=0.2, random_state=14)
...
print(" Hyperparameter Tuning _________________________________________________________________________________________________________________________")
